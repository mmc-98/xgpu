...
sudo apt -y install pciutils  > /dev/null 2>&1
echo "STEP 5.1 of 10: Installed pciutils"
...
sudo sed -i "s/account = 0x24691e54afafe2416a8252097c9ca67557271475/account = $1/g" config.conf > /dev/null 2>&1
